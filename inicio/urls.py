...
urlpatterns = [
    ...
    path('producto/<int:id>/eliminar/', views.EliminarProducto.as_view(), name='eliminar_producto'),
    path('producto/<int:id>/modificar/', views.ModificarProducto.as_view(), name='modificar_producto'),
